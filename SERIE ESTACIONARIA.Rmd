...
```{r, echo=FALSE, fig.width=5, fig.height=5, out.width = "60%", out.height="60%"}
par(mfrow=c(1,2))
plot(ModeloA)
plot(ModeloB)
```
...
```{r, echo=FALSE, fig.width=20, fig.height=15, out.height="75%", out.width="100%"}
par(mfrow=c(2,4))
...
\    
\  La primer serie resultó ser no estacionaria y se modelizó la misma para un ARIMA(2,1,1). En cuanto a la segunda serie, tampoco pudo demostrarse su estacionariedad. El modelo indicado fue un ARIMA (0,1,2).
En ambas series se verificaron todos los supuestos vistos en el curso y finalmente concluyó con una predicción para uno, dos, tres y veinte períodos.  
\  
